...
Revision ID: 66da7c773968
Revises: 
Create Date: 2024-06-14 02:51:37.482641
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['specialization_id'], ['specialization.id'], name='examination_ibfk_1'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    ...
    op.create_table('schedule_record',
    sa.Column('id', mysql.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('doctor_id', mysql.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['doctor_id'], ['examination.id'], name='schedule_record_ibfk_1'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
